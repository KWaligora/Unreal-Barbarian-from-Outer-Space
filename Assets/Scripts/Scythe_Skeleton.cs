...
public class Scythe_Skeleton : MonoBehaviour, IEnemy
{
    //move
    ...
    void Die()
    {
        ...
        ExpBall ball = Instantiate(expBall, GetComponentInParent<Scythe_Skeleton>().transform.position, Quaternion.Euler(new Vector3(0, 0, 0))).gameObject.GetComponent<ExpBall>();
        ball.Init(expValue);
